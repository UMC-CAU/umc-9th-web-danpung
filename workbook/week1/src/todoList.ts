const planInput = document.getElementById("todo-box__input") as HTMLInputElement;
const todoSection = document.getElementById("list-box__todo") as HTMLDivElement;
const doneSection = document.getElementById("list-box__done") as HTMLDivElement;
const addButton = document.getElementById("todo-box__button") as HTMLButtonElement;
